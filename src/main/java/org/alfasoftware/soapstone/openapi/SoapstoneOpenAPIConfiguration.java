...
public class SoapstoneOpenAPIConfiguration {


  private static SoapstoneOpenAPIConfiguration instance;
  ...
  private SoapstoneOpenAPIConfiguration() {
  }

  public synchronized static SoapstoneOpenAPIConfiguration get() {
    if (instance == null) {
      instance = new SoapstoneOpenAPIConfiguration();
    }
    return instance;
  }
